export const errorMessageDefinitions = Object.freeze([
  ...
  { key: 'whitelist_denied', label: '白名单拦截', status: 400, defaultValue: '公益模型仅限在RP-Hub官方源站使用，如您再次尝试不合规请求，账号将遭到封禁，请切换付费分组或转至官方源站使用' },
  { key: 'memory_backfill_denied', label: '公益模型记忆补录拦截', status: 400, defaultValue: '公益模型不支持记忆补录' },
